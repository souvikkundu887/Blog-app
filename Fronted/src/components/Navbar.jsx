...
function Navbar() {
  ...
  return (
    <>
      <div >
        <div className="bg-amber-100 h-[57px] px-8 py-2 flex justify-between">
          <div className="flex gap-4 items-center">
            ...
            <div className=" relative">
              <i class="fi fi-rr-search text-xl text-gray-600 absolute top-1/2 -translate-y-1/2 mx-1 opacity-60"></i>
              <input type="text" className="bg-white  focus:outline-none rounded-xl px-8 py-2 " placeholder="Search" />
            </div>
          </div>
          <div className="flex gap-4 items-center">
            ...
            {token? <div>hello</div>:<div className={`flex gap-2 `}>
